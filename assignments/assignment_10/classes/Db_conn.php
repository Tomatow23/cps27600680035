...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'nmdunn';//this will be your WCC username
      $dbUsr = 'nmdunn';//this will be your WCC username
      $dbPass = '4UBjY779HZgU';//this will be the password found in the video.
